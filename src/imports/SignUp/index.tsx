import svgPaths from "./svg-sja7w5pqov";
...
function Header() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[8px] items-center leading-[normal] relative shrink-0 w-full whitespace-nowrap" data-name="header">
      ...
      <p className="font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal relative shrink-0 text-[#666] text-[14px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        교육 개발자 계정을 생성하세요
      </p>
    </div>
  );
...
function Frame() {
  return (
    <div className="bg-white content-stretch flex h-[38px] items-center px-[12px] relative rounded-[4px] shrink-0 w-full" data-name="Frame">
      <div aria-hidden className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="[word-break:break-word] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#212121] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        dev_learner
      </p>
    </div>
  );
...
function UserField() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="user-field">
      <p className="[word-break:break-word] font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#666] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        사용자 이름 *
      </p>
      <Frame />
    </div>
...
function EmailField() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="email-field">
      <p className="[word-break:break-word] font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#666] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        이메일 *
      </p>
      <Frame1 />
...
function Frame2() {
  return (
    <div className="bg-white content-stretch flex h-[38px] items-center px-[12px] relative rounded-[4px] shrink-0 w-full" data-name="Frame">
      <div aria-hidden className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="[word-break:break-word] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#9e9e9e] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        ••••••••
      </p>
    </div>
  );
...
function PasswordField() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="password-field">
      <p className="[word-break:break-word] font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#666] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        비밀번호 *
      </p>
      <Frame2 />
...
function ConfirmField() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="confirm-field">
      <p className="[word-break:break-word] font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#666] text-[11px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        비밀번호 확인 *
      </p>
      <Frame3 />
...
function GoogleButton() {
  return (
    <div className="content-stretch flex gap-[10px] h-[38px] items-center justify-center relative rounded-[4px] shrink-0 w-full" data-name="google-button">
      <div aria-hidden className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <IconGoogle />
...
function GithubButton() {
  return (
    <div className="content-stretch flex gap-[10px] h-[38px] items-center justify-center relative rounded-[4px] shrink-0 w-full" data-name="github-button">
      <div aria-hidden className="absolute border border-[#e0e0e0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <IconGithub />
      <p className="[word-break:break-word] font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#212121] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        GitHub로 가입
...
function SocialButtons() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="social-buttons">
      <GoogleButton />
      <GithubButton />
    </div>
  );
...
function FooterLink() {
  return (
    <div className="content-stretch flex items-start justify-center pt-[8px] relative shrink-0 w-full" data-name="footer-link">
...
function SignUpCard() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.12)] flex flex-col gap-[20px] items-start p-[32px] relative rounded-[8px] shrink-0 w-[400px]" data-name="SignUpCard">
      <Header />
      <Form />
      <PrimaryButton />
      <Divider />
...
export default function SignUp() {
  return (
    <div className="bg-[#f5f5f5] content-stretch flex flex-col items-center justify-center p-[40px] relative size-full" data-name="sign-up">
      <SignUpCard />
    </div>
  );
}